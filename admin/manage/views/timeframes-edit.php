			...
			<tr class="form-field">
				<td colspan="4">
					...
					if ( $item['has_end_date'] != 1 ) {
						printf ( __('<strong>End date</strong>: No end date. Users will be able to book %d days in advance. (Edit in %s)', 'commons-booking'), CB_Settings::get( 'calendar', 'range'), CB_Gui::settings_admin_url( 'calendar' ) ); //@TODO get from settings
					} else {
