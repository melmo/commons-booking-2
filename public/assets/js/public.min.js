!function(t, i) {
    ...
    function l(t, i) {
        for (var e in t.hasOwnProperty("options") || (t.options = t.options ? Qt(t.options) : {}), 
        i) t.options[e] = i[e];
        return t.options;
    }
    function c(t, i, e) {
    ...
    function w(t, i, e) {
        return t instanceof x ? t : ei(t) ? new x(t[0], t[1]) : null == t ? t : "object" == typeof t && "x" in t && "y" in t ? new x(t.x, t.y) : new x(t, i, e);
    }
    function P(t, i) {
    ...
    function C(t, i, e) {
        return t instanceof M ? t : ei(t) && "object" != typeof t[0] ? 3 === t.length ? new M(t[0], t[1], t[2]) : 2 === t.length ? new M(t[0], t[1]) : null : null == t ? t : "object" == typeof t && "lat" in t ? new M(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : void 0 === i ? null : new M(t, i, e);
    }
    function Z(t, i, e, n) {
    ...
    function A(t, i, e, n) {
        return "touchstart" === i ? O(t, e, n) : "touchmove" === i ? function(t, i, e) {
            var n = function(t) {
    ...
    function O(t, i, n) {
        ...
        t["_leaflet_touchstart" + n] = o, t.addEventListener(Qi, o, !1), se || (document.documentElement.addEventListener(Qi, R, !0), 
        document.documentElement.addEventListener(te, D, !0), document.documentElement.addEventListener(ie, N, !0), 
        document.documentElement.addEventListener(ee, N, !0), se = !0);
    }
    function R(t) {
        oe[t.pointerId] = t, re++;
    }
    ...
    function j(t, i) {
        for (var e in t.touches = [], oe) t.touches.push(oe[e]);
    ...
    function F(t, i, e) {
        function n(t) {
            ...
            if (!(1 < i)) {
                ...
                r = t.touches ? t.touches[0] : t, a = 0 < n && n <= h, s = e;
            }
        }
        function o(t) {
            if (a && !r.cancelBubble) {
        ...
        var s, r, a = !1, h = 250;
        return t[ue + ae + e] = n, t[ue + he + e] = o, t[ue + "dblclick" + e] = i, t.addEventListener(ae, n, !1), 
        t.addEventListener(he, o, !1), t.addEventListener("dblclick", i, !1), this;
    }
    function U(t, i) {
        var e = t[ue + ae + i], n = t[ue + he + i], o = t[ue + "dblclick" + i];
        return t.removeEventListener(ae, e, !1), t.removeEventListener(he, n, !1), Pi || t.removeEventListener("dblclick", o, !1), 
        this;
    }
    function V(t, i, e, n) {
    ...
    function G(t, i, e, o) {
        ...
        Ui && 0 === i.indexOf("touch") ? A(t, i, r, s) : !Vi || "dblclick" !== i || Ui && Si ? "addEventListener" in t ? "mousewheel" === i ? t.addEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1) : "mouseenter" === i || "mouseleave" === i ? (r = function(i) {
            ...
            !function(t, i) {
                ...
                n && 100 < n && n < 500 || t.target._simulatedClick && !t._simulated ? Q(t) : (pi = e, 
                i(t));
            }(t, a);
    ...
    function K(t, i, e, o) {
        ...
        if (!r) return this;
        Ui && 0 === i.indexOf("touch") ? function(t, i, e) {
            var n = t["_leaflet_" + i + e];
            "touchstart" === i ? t.removeEventListener(Qi, n, !1) : "touchmove" === i ? t.removeEventListener(te, n, !1) : "touchend" === i && (t.removeEventListener(ie, n, !1), 
            t.removeEventListener(ee, n, !1));
        }(t, i, s) : !Vi || "dblclick" !== i || Ui && Si ? "removeEventListener" in t ? "mousewheel" === i ? t.removeEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1) : t.removeEventListener("mouseenter" === i ? "mouseover" : "mouseleave" === i ? "mouseout" : i, r, !1) : "detachEvent" in t && t.detachEvent("on" + i, r) : U(t, s), 
        t[le][s] = null;
    }
    function Y(t) {
    ...
    function zt(t) {
        ...
        t.style && (Mt(), ye = (ve = t).style.outline, t.style.outline = "none", V(window, "keydown", Mt));
    }
    function Mt() {
        ve && (ve.style.outline = ye, ye = ve = void 0, q(window, "keydown", Mt));
    }
    function Ct(t, i) {
        ...
        return function(t, i) {
            ...
            n[0] = n[e - 1] = 1, function Et(t, i, e, n, o) {
                var s, r, a, h = 0;
                for (r = n + 1; r <= o - 1; r++) (a = Rt(t[r], t[n], t[o], !0)) > h && (s = r, h = a);
                e < h && (i[s] = 1, Et(t, i, e, n, s), Et(t, i, e, s, o));
            }(t, n, i, 0, e - 1);
            var o, s = [];
    ...
    function Rt(t, i, e, n) {
        ...
        r += h * o)), a = t.x - s, h = t.y - r, n ? a * a + h * h : new x(s, r);
    }
    function Dt(t) {
    ...
    function jt(t, i, e) {
        ...
        for (r = 0; r < 4; r++) {
            ...
            h = t[s], a._code & l ? h._code & l || ((c = At(h, a, l, i, e))._code = Bt(c, i), 
            n.push(c)) : (h._code & l && ((c = At(h, a, l, i, e))._code = Bt(c, i), n.push(c)), 
            n.push(a));
            t = n;
        }
        return t;
    ...
    v.extend = function(t) {
        ...
        for (var s in (o.constructor = e).prototype = o, this) this.hasOwnProperty(s) && "prototype" !== s && "__super__" !== s && (e[s] = this[s]);
        return t.statics && (i(e, t.statics), delete t.statics), t.includes && (function(t) {
            if ("undefined" != typeof L && L && L.Mixin) {
                t = ei(t) ? t : [ t ];
                for (var i = 0; i < t.length; i++) t[i] === L.Mixin.Events && console.warn("Deprecated include of L.Mixin.Events: this property will be removed in future releases, please inherit from L.Evented instead.", new Error().stack);
            }
        }(t.includes), i.apply(null, [ o ].concat(t.includes)), delete t.includes), o.options && (t.options = i(Qt(o.options), t.options)), 
        i(o, t), o._initHooks = [], o.callInitHooks = function() {
    ...
    var hi = {
        ...
        addEventParent: function(t) {
            return this._eventParents = this._eventParents || {}, this._eventParents[n(t)] = t, 
            this;
        },
    ...
    hi.addEventListener = hi.on, hi.removeEventListener = hi.clearAllEventListeners = hi.off, 
    hi.addOneTimeEventListener = hi.once, hi.fireEvent = hi.fire, hi.hasEventListeners = hi.listens;
    ...
    x.prototype = {
        ...
        extend: function(t) {
            return t = w(t), this.min || this.max ? (this.min.x = Math.min(t.x, this.min.x), 
        ...
        extend: function(t) {
            ...
            if (t instanceof M) e = i = t; else {
                if (!(t instanceof T)) return t ? this.extend(C(t) || z(t)) : this;
                if (i = t._southWest, e = t._northEast, !i || !e) return this;
            }
            return n || o ? (n.lat = Math.min(i.lat, n.lat), n.lng = Math.min(i.lng, n.lng), 
            o.lat = Math.max(e.lat, o.lat), o.lng = Math.max(e.lng, o.lng)) : (this._southWest = new M(i.lat, i.lng), 
            this._northEast = new M(e.lat, e.lng)), this;
        },
        pad: function(t) {
    ...
    var pi, mi, fi, gi, vi = i({}, _i, {
        ...
        code: "EPSG:900913"
    }), xi = document.documentElement.style, wi = "ActiveXObject" in window, Li = wi && !document.addEventListener, Pi = "msLaunchUri" in navigator && !("documentMode" in document), bi = I("webkit"), Ti = I("android"), zi = I("android 2") || I("android 3"), Mi = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Ci = Ti && I("Google") && Mi < 537 && !("AudioNode" in window), Zi = !!window.opera, Si = I("chrome"), Ei = I("gecko") && !bi && !Zi && !wi, ki = !Si && I("safari"), Ii = I("phantom"), Ai = "OTransition" in xi, Bi = 0 === navigator.platform.indexOf("Win"), Oi = wi && "transition" in xi, Ri = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !zi, Di = "MozPerspective" in xi, Ni = !window.L_DISABLE_3D && (Oi || Ri || Di) && !Ai && !Ii, ji = "undefined" != typeof orientation || I("mobile"), Wi = ji && bi, Hi = ji && Ri, Fi = !window.PointerEvent && window.MSPointerEvent, Ui = !(!window.PointerEvent && !Fi), Vi = !window.L_NO_TOUCH && (Ui || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch), qi = ji && Zi, Gi = ji && Ei, Ki = 1 < (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI), Yi = !!document.createElement("canvas").getContext, Xi = !(!document.createElementNS || !E("svg").createSVGRect), Ji = !Xi && function() {
        try {
    ...
    var ve, ye, xe = (Object.freeze || Object)({
        ...
        run: function(t, i, e, n) {
            ...
            this._startPos = Pt(t), this._offset = i.subtract(this._startPos), this._startTime = +new Date(), 
        ...
        initialize: function(t, i) {
            ...
            this.callInitHooks(), this._zoomAnimated = me && Ni && !qi && this.options.zoomAnimation, 
        ...
        setView: function(t, e, n) {
            ...
            n = n || {}, this._stop(), this._loaded && !n.reset && !0 !== n && (void 0 !== n.animate && (n.zoom = i({
                ...
                animate: n.animate,
                duration: n.duration
            }, n.pan)), this._zoom !== e ? this._tryAnimatedZoom && this._tryAnimatedZoom(t, e, n.zoom) : this._tryAnimatedPan(t, n.pan)) ? clearTimeout(this._sizeTimer) : this._resetView(t, e), 
            this;
        },
        ...
        panBy: function(t, i) {
            if (i = i || {}, !(t = w(t).round()).x && !t.y) return this.fire("moveend");
        ...
        flyTo: function(t, i, e) {
            ...
            return this._moveStart(!0, e.noMoveStart), function l() {
                var e = (Date.now() - L) / b, n = function(t) {
                    return 1 - Math.pow(1 - t, 1.5);
                }(e) * P;
                e <= 1 ? (this._flyToFrame = f(l, this), this._move(this.unproject(c.add(_.subtract(c).multiplyBy(h(n) / v)), p), this.getScaleZoom(m / function(t) {
        ...
        invalidateSize: function(t) {
            ...
            this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(e(this.fire, this, "moveend"), 200)) : this.fire("moveend")), 
            this.fire("resize", {
                oldSize: n,
                newSize: o
            })) : this;
        ...
        remove: function() {
            ...
            var t;
            for (t in void 0 !== this._locationWatchId && this.stopLocate(), this._stop(), ut(this._mapPane), 
            this._clearControlPos && this._clearControlPos(), this._clearHandlers(), this._loaded && this.fire("unload"), 
        ...
        _initPanes: function() {
            ...
            Lt(this._mapPane, new x(0, 0)), this.createPane("tilePane"), this.createPane("shadowPane"), 
        ...
        _initEvents: function(t) {
            this._targets = {};
            var i = t ? q : V;
            i((this._targets[n(this._container)] = this)._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress", this._handleDOMEvent, this), 
            this.options.trackResize && i(window, "resize", this._onResize, this), Ni && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd);
        },
        _onResize: function() {
        ...
        _animateZoom: function(t, i, n, o) {
            this._mapPane && (n && (this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = i, 
            pt(this._mapPane, "leaflet-zoom-anim")), this.fire("zoomanim", {
                center: t,
                zoom: i,
                noUpdate: o
        ...
        remove: function() {
            return this._map && (ut(this._container), this.onRemove && this.onRemove(this._map), 
            this._map = null), this;
        },
    ...
    var Te = Pe.extend({
        ...
        initialize: function(t, i, e) {
            for (var n in l(this, e), this._layerControlInputs = [], this._layers = [], this._lastZIndex = 0, 
        ...
        _update: function() {
            ...
            i = i || n.overlay, t = t || !n.overlay, o += n.overlay ? 0 : 1;
        ...
        _createButton: function(t, i, e, n, o) {
            ...
            s.setAttribute("aria-label", i), J(s), V(s, "click", Q), V(s, "click", o, this), 
            V(s, "click", this._refocusOnMap, this), s;
        },
    ...
    var Me = Pe.extend({
        ...
        onAdd: function(t) {
            for (var i in (t.attributionControl = this)._container = ht("div", "leaflet-control-attribution"), 
            J(this._container), t._layers) t._layers[i].getAttribution && this.addAttribution(t._layers[i].getAttribution());
    ...
    var Se, Ee = {
        ...
        disable: function() {
            this._enabled && (Be._dragging === this && this.finishDrag(), q(this._dragStartTarget, ke, this._onDown, this), 
            this._enabled = !1, this._moved = !1);
        },
        _onDown: function(t) {
            if (!t._simulated && this._enabled && (this._moved = !1, !dt(this._element, "leaflet-zoom-anim") && !(Be._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((Be._dragging = this)._preventOutline && zt(this._element), 
            bt(), mi(), this._moving)))) {
                this.fire("down");
                var i = t.touches ? t.touches[0] : t;
                this._startPoint = new x(i.clientX, i.clientY), V(document, Ae[t.type], this._onMove, this), 
        ...
        finishDrag: function() {
            for (var t in mt(document.body, "leaflet-dragging"), this._lastTarget && (mt(this._lastTarget, "leaflet-drag-target"), 
            this._lastTarget = null), Ae) q(document, Ae[t], this._onMove, this), q(document, Ie[t], this._onUp, this);
    ...
    ci.Earth = _i, ci.EPSG3395 = We, ci.EPSG3857 = vi, ci.EPSG900913 = yi, ci.EPSG4326 = He, 
    ci.Simple = Fe;
    var Ue = ui.extend({
        options: {
            pane: "overlayPane",
    ...
    var Ve = Ue.extend({
        initialize: function(t, i) {
            var e, n;
            if (l(this, i), this._layers = {}, t) for (e = 0, n = t.length; e < n; e++) this.addLayer(t[e]);
        },
        addLayer: function(t) {
        ...
        addLayer: function(t) {
            return this.hasLayer(t) ? this : (t.addEventParent(this), Ve.prototype.addLayer.call(this, t), 
            this.fire("layeradd", {
                layer: t
            }));
        },
        removeLayer: function(t) {
            ...
            Ve.prototype.removeLayer.call(this, t), this.fire("layerremove", {
                layer: t
            })) : this;
        },
        setStyle: function(t) {
        ...
        _adjustPan: function(t) {
            ...
            if (!h.contains(s)) {
                ...
                e.panBy(u, {
                    animate: !1
                }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), L.DomUtil.setPosition(i._icon, this._draggable._newPos), 
                this._onDrag(t), this._panRequest = f(this._adjustPan.bind(this, t));
            }
        },
        ...
        _initInteraction: function() {
            if (this.options.interactive && (pt(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), 
            Ye)) {
                var t = this.options.draggable;
                this.dragging && (t = this.dragging.enabled(), this.dragging.disable()), this.dragging = new Ye(this), 
        ...
        getCenter: function() {
            ...
            for (n = t = 0; t < h - 1; t++) if (o = a[t], s = a[t + 1], (n += e = o.distanceTo(s)) > i) return r = (n - i) / e, 
        ...
        _convertLatLngs: function(t) {
            for (var i = [], e = Dt(t), n = 0, o = t.length; n < o; n++) e ? (i[n] = C(t[n]), 
        ...
        _clipPoints: function() {
            ...
            if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) if (this.options.noClip) this._parts = this._rings; else {
                ...
                for (n = i = 0, o = this._rings.length; i < o; i++) for (e = 0, s = (a = this._rings[i]).length; e < s - 1; e++) (r = It(a[e], a[e + 1], t, e, !0)) && (h[n] = h[n] || [], 
    ...
    var en = tn.extend({
        ...
        _convertLatLngs: function(t) {
            ...
            return 2 <= e && i[0] instanceof M && i[0].equals(i[e - 1]) && i.pop(), i;
        },
        _setLatLngs: function(t) {
        ...
        addData: function(t) {
            ...
            var r = Wt(t, s);
            return r ? (r.feature = Gt(t), r.defaultOptions = r.options, this.resetStyle(r), 
            s.onEachFeature && s.onEachFeature(t, r), this.addLayer(r)) : this;
        },
        resetStyle: function(t) {
            return t.options = i({}, t.defaultOptions), this._setLayerStyle(t, this.options.style), 
            this;
        },
        setStyle: function(t) {
    ...
    Xe.include(on), Qe.include(on), $e.include(on), tn.include({
        toGeoJSON: function(t) {
            ...
            return qt(this, {
                ...
                coordinates: Vt(this._latlngs, i ? 1 : 0, !1, t)
            });
        }
    }), en.include({
        toGeoJSON: function(t) {
    ...
    var sn = Kt, rn = Ue.extend({
        ...
        _initImage: function() {
            ...
            this.options.className && pt(i, this.options.className), i.onselectstart = r, i.onmousemove = r, 
            i.onload = e(this.fire, this, "load"), i.onerror = e(this._overlayOnError, this, "error"), 
        ...
        _initImage: function() {
            ...
            t) {
                ...
                this._url = 0 < n.length ? o : [ i.src ];
            } else {
                ei(this._url) || (this._url = [ this._url ]), i.autoplay = !!this.options.autoplay, 
        ...
        onAdd: function(t) {
            this._zoomAnimated = t._zoomAnimated, this._container || this._initLayout(), t._fadeAnimated && vt(this._container, 0), 
            clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), 
            this.update(), t._fadeAnimated && vt(this._container, 1), this.bringToFront();
        },
        onRemove: function(t) {
        ...
        _updateLayout: function() {
            ...
            var e = t.offsetWidth;
            e = Math.min(e, this.options.maxWidth), e = Math.max(e, this.options.minWidth), 
            i.width = e + 1 + "px", i.whiteSpace = "", i.height = "";
            var n = t.offsetHeight, o = this.options.maxHeight;
            o && o < n ? (i.height = o + "px", pt(t, "leaflet-popup-scrolled")) : mt(t, "leaflet-popup-scrolled"), 
    ...
    Le.mergeOptions({
        ...
        openPopup: function(t, i, e) {
            return t instanceof un || (t = new un(e).setContent(t)), i && t.setLatLng(i), this.hasLayer(t) ? this : (this._popup && this._popup.options.autoClose && this.closePopup(), 
        ...
        bindPopup: function(t, i) {
            return t instanceof un ? (l(t, i), (this._popup = t)._source = this) : (this._popup && !i || (this._popup = new un(i, this)), 
        ...
        openPopup: function(t, i) {
            ...
            return i || (i = t.getCenter ? t.getCenter() : t.getLatLng()), this._popup && this._map && (this._popup._source = t, 
    ...
    Le.include({
        ...
        bindTooltip: function(t, i) {
            return t instanceof ln ? (l(t, i), (this._tooltip = t)._source = this) : (this._tooltip && !i || (this._tooltip = new ln(i, this)), 
        ...
        openTooltip: function(t, i) {
            ...
            this._tooltip.update(), this._map.openTooltip(this._tooltip, i), this._tooltip.options.interactive && this._tooltip._container && (pt(this._tooltip._container, "leaflet-clickable"), 
    ...
    var _n = Ue.extend({
        ...
        onRemove: function(t) {
            this._removeAllTiles(), ut(this._container), t._removeZoomLimit(this), this._container = null, 
        ...
        _updateLevels: function() {
            ...
            if (void 0 !== t) {
                for (var e in this._levels) this._levels[e].el.children.length || e === t ? (this._levels[e].el.style.zIndex = i - Math.abs(t - e), 
                this._onUpdateLevel(e)) : (ut(this._levels[e].el), this._removeTilesAtZoom(e), this._onRemoveLevel(e), 
                ...
                n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), n.el.offsetWidth, 
        ...
        _initTile: function(t) {
            ...
            t.style.width = i.x + "px", t.style.height = i.y + "px", t.onselectstart = r, t.onmousemove = r, 
            Li && this.options.opacity < 1 && vt(t, this.options.opacity), Ti && !zi && (t.style.WebkitBackfaceVisibility = "hidden");
        },
        ...
        _tileReady: function(t, i, n) {
            if (this._map) {
                ...
                (n = this._tiles[o]) && (n.loaded = +new Date(), this._map._fadeAnimated ? (vt(n.el, 0), 
                g(this._fadeFrame), this._fadeFrame = f(this._updateOpacity, this)) : (n.active = !0, 
        ...
        initialize: function(t, i) {
            this._url = t, (i = l(this, i)).detectRetina && Ki && 0 < i.maxZoom && (i.tileSize = Math.floor(i.tileSize / 2), 
            i.zoomReverse ? (i.zoomOffset--, i.minZoom++) : (i.zoomOffset++, i.maxZoom--), i.minZoom = Math.max(0, i.minZoom)), 
            "string" == typeof i.subdomains && (i.subdomains = i.subdomains.split("")), Ti || this.on("tileunload", this._onTileRemove);
        },
        setUrl: function(t, i) {
        ...
        createTile: function(t, i) {
            ...
            return V(n, "load", e(this._tileOnLoad, this, i, n)), V(n, "error", e(this._tileOnError, this, i, n)), 
        ...
        getTileUrl: function(t) {
            var i = this._tileCoordsToNwSe(t), e = this._crs, n = b(e.project(i[0]), e.project(i[1])), o = n.min, s = n.max, r = (1.3 <= this._wmsVersion && this._crs === He ? [ o.y, o.x, s.y, s.x ] : [ o.x, o.y, s.x, s.y ]).join(","), a = L.TileLayer.prototype.getTileUrl.call(this, t);
    ...
    var mn = Ue.extend({
        ...
        _initContainer: function() {
            ...
            V(t, "mousemove", o(this._onMouseMove, 32, this), this), V(t, "click dblclick mousedown mouseup contextmenu", this._onClick, this), 
        ...
        _reset: function() {
            mn.prototype._reset.call(this), this._postponeUpdatePaths && (this._postponeUpdatePaths = !1, 
            this._updatePaths());
        },
        _initPath: function(t) {
            this._updateDashArray(t);
            var i = (this._layers[n(t)] = t)._order = {
                layer: t,
                prev: this._drawLast,
                next: null
            };
        ...
        _removePath: function(t) {
            ...
            delete this._layers[L.stamp(t)], this._requestRedraw(t);
        },
        ...
        _updateCircle: function(t) {
            if (this._drawing && !t._empty()) {
                ...
                this._drawnLayers[t._leaflet_id] = t, 1 !== o && (e.save(), e.scale(1, o)), e.beginPath(), 
                e.arc(i.x, i.y / o, n, 0, 2 * Math.PI, !1), 1 !== o && e.restore(), this._fillStroke(e, t);
            }
        },
        ...
        _handleMouseOut: function(t) {
            ...
            i && (mt(this._container, "leaflet-interactive"), this._fireEvent([ i ], t, "mouseout"), 
        ...
        _bringToFront: function(t) {
            var i = t._order, e = i.next, n = i.prev;
            e && ((e.prev = n) ? n.next = e : e && (this._drawFirst = e), i.prev = this._drawLast, 
            (this._drawLast.next = i).next = null, this._drawLast = i, this._requestRedraw(t));
        },
        _bringToBack: function(t) {
            var i = t._order, e = i.next, n = i.prev;
            n && ((n.next = e) ? e.prev = n : n && (this._drawLast = n), i.prev = null, i.next = this._drawFirst, 
            this._drawFirst.prev = i, this._drawFirst = i, this._requestRedraw(t));
        }
    }), gn = function() {
        try {
        ...
        _initPath: function(t) {
            ...
            t._path = gn("path"), i.appendChild(t._path), this._updateStyle(t), this._layers[n(t)] = t;
        },
        _addPath: function(t) {
            var i = t._container;
        ...
        _initContainer: function() {
            this._container = yn("svg"), this._container.setAttribute("pointer-events", "none"), 
            this._rootGroup = yn("g"), this._container.appendChild(this._rootGroup);
        },
        _destroyContainer: function() {
            ut(this._container), q(this._container), delete this._container, delete this._rootGroup, 
        ...
        _update: function() {
            if (!this._map._animatingZoom || !this._bounds) {
                ...
                this._svgSize && this._svgSize.equals(i) || (this._svgSize = i, e.setAttribute("width", i.x), 
                e.setAttribute("height", i.y)), Lt(e, t.min), e.setAttribute("viewBox", [ t.min.x, t.min.y, i.x, i.y ].join(" ")), 
                this.fire("update");
            }
        },
        _initPath: function(t) {
            ...
            this._updateStyle(t), this._layers[n(t)] = t;
        },
        _addPath: function(t) {
    ...
    Ji && xn.include(vn), Le.include({
        getRenderer: function(t) {
            ...
            return i || (i = this._renderer = this.options.preferCanvas && Xt() || Jt()), this.hasLayer(i) || this.addLayer(i), 
            i;
        },
    ...
    nn.coordsToLatLngs = Ft, nn.latLngToCoords = Ut, nn.latLngsToCoords = Vt, nn.getFeature = qt, 
    nn.asFeature = Gt, Le.mergeOptions({
        boxZoom: !0
    });
    var Ln = Ze.extend({
        initialize: function(t) {
        ...
        _onMouseDown: function(t) {
            ...
            this._clearDeferredResetState(), this._resetState(), mi(), bt(), this._startPoint = this._map.mouseEventToContainerPoint(t), 
            V(document, {
                contextmenu: Q,
        ...
        _onMouseMove: function(t) {
            ...
            pt(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
        ...
        _finish: function() {
            this._moved && (ut(this._box), mt(this._container, "leaflet-crosshair")), fi(), 
            Tt(), q(document, {
                contextmenu: Q,
                mousemove: this._onMouseMove,
                mouseup: this._onMouseUp,
    ...
    var bn = Ze.extend({
        ...
        removeHooks: function() {
            mt(this._map._container, "leaflet-grab"), mt(this._map._container, "leaflet-touch-drag"), 
    ...
    var Mn = Ze.extend({
        ...
        _onDown: function(t) {
            if (t.touches) {
                if ($(t), this._fireClick = !0, 1 < t.touches.length) return this._fireClick = !1, 
        ...
        _onUp: function(t) {
            if (clearTimeout(this._holdTimeout), q(document, {
                ...
                e && e.tagName && "a" === e.tagName.toLowerCase() && mt(e, "leaflet-active"), this._simulateEvent("mouseup", i), 
    ...
    var Cn = Ze.extend({
        ...
        _onTouchStart: function(t) {
            ...
            if (t.touches && 2 === t.touches.length && !i._animatingZoom && !this._zooming) {
                ...
                V(document, "touchend", this._onTouchEnd, this), $(t);
            }
        },
        _onTouchMove: function(t) {
            if (t.touches && 2 === t.touches.length && this._zooming) {
                ...
                if (this._zoom = i.getScaleZoom(s, this._startZoom), !i.options.bounceAtZoomLimits && (this._zoom < i.getMinZoom() && s < 1 || this._zoom > i.getMaxZoom() && 1 < s) && (this._zoom = i._limitZoom(this._zoom)), 
        ...
        _onTouchEnd: function() {
            this._moved && this._zooming ? (this._zooming = !1, g(this._animRequest), q(document, "touchmove", this._onTouchMove), 
            q(document, "touchend", this._onTouchEnd), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom))) : this._zooming = !1;
        }
    });
    Le.addInitHook("addHandler", "touchZoom", Cn), Le.BoxZoom = Ln, Le.DoubleClickZoom = Pn, 
    Le.Drag = bn, Le.Keyboard = Tn, Le.ScrollWheelZoom = zn, Le.Tap = Mn, Le.TouchZoom = Cn;
    var Zn = window.L;
    window.L = t, Object.freeze = $t, t.version = "1.3.1", t.noConflict = function() {
        return window.L = Zn, this;
    }, t.Control = Pe, t.control = be, t.Browser = $i, t.Evented = ui, t.Mixin = Ee, 
    ...
    t.Transformation = Z, t.transformation = S, t.Projection = je, t.LatLng = M, t.latLng = C, 
    t.LatLngBounds = T, t.latLngBounds = z, t.CRS = ci, t.GeoJSON = nn, t.geoJSON = Kt, 
    t.geoJson = sn, t.Layer = Ue, t.LayerGroup = Ve, t.layerGroup = function(t, i) {
        return new Ve(t, i);
        ...
        return new _n(t);
    }, t.SVG = xn, t.svg = Jt, t.Renderer = mn, t.Canvas = fn, t.canvas = Xt, t.Path = Je, 
    t.CircleMarker = $e, t.circleMarker = function(t, i) {
        return new $e(t, i);
    ...
    "object" == typeof exports && "undefined" != typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define(factory) : global.tippy = factory();
}(this, function() {
    "use strict";
    var isBrowser = "undefined" != typeof window, isIE = isBrowser && /MSIE |Trident\//.test(navigator.userAgent), browser = {};
    isBrowser && (browser.supported = "requestAnimationFrame" in window, browser.supportsTouch = "ontouchstart" in window, 
    browser.usingTouch = !1, browser.dynamicInputDetection = !0, browser.iOS = /iPhone|iPad|iPod/.test(navigator.platform) && !window.MSStream, 
    ...
    var selectors = {
        ...
        onHide: function() {},
        onHidden: function() {}
    }, defaultsKeys = browser.supported && Object.keys(defaults);
    ...
    function prefix(property) {
        for (var prefixes = [ "", "webkit" ], upperProp = property.charAt(0).toUpperCase() + property.slice(1), i = 0; i < prefixes.length; i++) {
            var _prefix = prefixes[i], prefixedProp = _prefix ? _prefix + upperProp : property;
            if (void 0 !== document.body.style[prefixedProp]) return prefixedProp;
        }
        return null;
    }
    ...
    function removeTitle(el) {
        ...
        title && el.setAttribute("data-original-title", title), el.removeAttribute("title");
    }
    for (var isBrowser$1 = "undefined" != typeof window && "undefined" != typeof document, longerTimeoutBrowsers = [ "Edge", "Trident", "Firefox" ], timeoutDuration = 0, i = 0; i < longerTimeoutBrowsers.length; i += 1) if (isBrowser$1 && 0 <= navigator.userAgent.indexOf(longerTimeoutBrowsers[i])) {
        timeoutDuration = 1;
        break;
    }
    var debounce = isBrowser$1 && window.Promise ? function(fn) {
        var called = !1;
        return function() {
    ...
    var isIE11 = isBrowser$1 && !(!window.MSInputMethodContext || !document.documentMode), isIE10 = isBrowser$1 && /MSIE 10/.test(navigator.userAgent);
    function isIE$1(version) {
        return 11 === version ? isIE11 : 10 === version ? isIE10 : isIE11 || isIE10;
    }
    function getOffsetParent(element) {
        if (!element) return document.documentElement;
        for (var noOffsetParent = isIE$1(10) ? document.body : null, offsetParent = element.offsetParent; offsetParent === noOffsetParent && element.nextElementSibling; ) offsetParent = (element = element.nextElementSibling).offsetParent;
    ...
    function getScroll(element) {
        var upperSide = "top" === (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "top") ? "scrollTop" : "scrollLeft", nodeName = element.nodeName;
    ...
    function getSize(axis, body, html, computedStyle) {
        return Math.max(body["offset" + axis], body["scroll" + axis], html["client" + axis], html["offset" + axis], html["scroll" + axis], isIE$1(10) ? html["offset" + axis] + computedStyle["margin" + ("Height" === axis ? "Top" : "Left")] + computedStyle["margin" + ("Height" === axis ? "Bottom" : "Right")] : 0);
    }
    function getWindowSizes() {
        var body = document.body, html = document.documentElement, computedStyle = isIE$1(10) && getComputedStyle(html);
        return {
    ...
    function getBoundingClientRect(element) {
        ...
        }, sizes = "HTML" === element.nodeName ? getWindowSizes() : {}, width = sizes.width || element.clientWidth || result.right - result.left, height = sizes.height || element.clientHeight || result.bottom - result.top, horizScrollbar = element.offsetWidth - width, vertScrollbar = element.offsetHeight - height;
    ...
    function getOffsetRectRelativeToArbitraryNode(children, parent) {
        var fixedPosition = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], isIE10 = isIE$1(10), isHTML = "HTML" === parent.nodeName, childrenRect = getBoundingClientRect(children), parentRect = getBoundingClientRect(parent), scrollParent = getScrollParent(children), styles = getStyleComputedProperty(parent), borderTopWidth = parseFloat(styles.borderTopWidth, 10), borderLeftWidth = parseFloat(styles.borderLeftWidth, 10);
        fixedPosition && "HTML" === parent.nodeName && (parentRect.top = Math.max(parentRect.top, 0), 
        ...
        return (isIE10 && !fixedPosition ? parent.contains(scrollParent) : parent === scrollParent && "BODY" !== scrollParent.nodeName) && (offsets = function(rect, element) {
            var subtract = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], scrollTop = getScroll(element, "top"), scrollLeft = getScroll(element, "left"), modifier = subtract ? -1 : 1;
    ...
    function getFixedPositionOffsetParent(element) {
        if (!element || !element.parentElement || isIE$1()) return document.documentElement;
        for (var el = element.parentElement; el && "none" === getStyleComputedProperty(el, "transform"); ) el = el.parentElement;
        return el || document.documentElement;
    }
    function getBoundaries(popper, reference, padding, boundariesElement) {
        var fixedPosition = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], boundaries = {
            top: 0,
            left: 0
        ...
        if ("viewport" === boundariesElement) boundaries = function(element) {
            ...
            }(offsetParent)) boundaries = offsets; else {
        ...
        return boundaries.left += padding, boundaries.top += padding, boundaries.right -= padding, 
        boundaries.bottom -= padding, boundaries;
    }
    function computeAutoPlacement(placement, refRect, popper, reference, boundariesElement) {
        ...
        }), computedPlacement = 0 < filteredAreas.length ? filteredAreas[0].key : sortedAreas[0].key, variation = placement.split("-")[1];
    ...
    function setupEventListeners(reference, options, state, updateBound) {
        ...
        }(scrollElement, "scroll", state.updateBound, state.scrollParents), state.scrollElement = scrollElement, 
        state.eventsEnabled = !0, state;
    }
    function disableEventListeners() {
        var reference, state;
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = (reference = this.reference, 
        state = this.state, getWindow(reference).removeEventListener("resize", state.updateBound), 
    ...
    function clockwise(placement) {
        var counter = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], index = validPlacements.indexOf(placement), arr = validPlacements.slice(index + 1).concat(validPlacements.slice(0, index));
    ...
    var Defaults = {
        ...
        modifiers: {
                ...
                fn: function(data, options) {
                    ...
                    var order = options.priority, popper = data.offsets.popper, check = {
                        primary: function(placement) {
                            ...
                            defineProperty$1({}, placement, value);
                        },
                        secondary: function(placement) {
                            ...
                            defineProperty$1({}, mainSide, value);
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(data, options) {
                    ...
                    } else if (!data.instance.popper.contains(arrowElement)) return console.warn("WARNING: `arrow.element` must be child of its popper element!"), 
                    data;
                    ...
                    data.arrowElement = arrowElement, data.offsets.arrow = (defineProperty$1(_data$offsets$arrow = {}, side, Math.round(sideValue)), 
                    defineProperty$1(_data$offsets$arrow, altSide, ""), _data$offsets$arrow), data;
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(data, options) {
                    ...
                    return flipOrder.forEach(function(step, index) {
                        ...
                        (overlapsRef || overflowsBoundaries) && (placement = flipOrder[index + 1]), flippedVariation && (variation = function(variation) {
            ...
            computeStyle: {
                ...
                fn: function(data, options) {
                    ...
                    var gpuAcceleration = void 0 !== legacyGpuAccelerationOption ? legacyGpuAccelerationOption : options.gpuAcceleration, offsetParentRect = getBoundingClientRect(getOffsetParent(data.instance.popper)), styles = {
                    ...
                    }, sideA = "bottom" === x ? "top" : "bottom", sideB = "right" === y ? "left" : "right", prefixedProperty = getSupportedPropertyName("transform"), left = void 0, top = void 0;
                    if (top = "bottom" === sideA ? -offsetParentRect.height + offsets.bottom : offsets.top, 
                    left = "right" === sideB ? -offsetParentRect.width + offsets.right : offsets.left, 
                    ...
                    return data.attributes = _extends$1({}, attributes, data.attributes), data.styles = _extends$1({}, styles, data.styles), 
                    data.arrowStyles = _extends$1({}, data.offsets.arrow, data.arrowStyles), data;
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
        ...
        function Popper(reference, popper) {
            var _this = this, options = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
            classCallCheck$1(this, Popper), this.scheduleUpdate = function() {
                return requestAnimationFrame(_this.update);
            }, this.update = debounce(this.update.bind(this)), this.options = _extends$1({}, Popper.Defaults, options), 
            this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
            }, this.reference = reference && reference.jquery ? reference[0] : reference, this.popper = popper && popper.jquery ? popper[0] : popper, 
            this.options.modifiers = {}, Object.keys(_extends$1({}, Popper.Defaults.modifiers, options.modifiers)).forEach(function(name) {
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        popperStyles.top = "", popperStyles.left = "", popperStyles[getSupportedPropertyName("transform")] = "", 
    ...
    function transformNumbersBasedOnPlacementAxis(type, numbers, isVertical, isReverse) {
        return numbers.length ? {
            scale: 1 === numbers.length ? "" + numbers[0] : isVertical ? numbers[0] + ", " + numbers[1] : numbers[1] + ", " + numbers[0],
            translate: 1 === numbers.length ? isReverse ? -numbers[0] + "px" : numbers[0] + "px" : isVertical ? isReverse ? numbers[0] + "px, " + -numbers[1] + "px" : numbers[0] + "px, " + numbers[1] + "px" : isReverse ? -numbers[1] + "px, " + numbers[0] + "px" : numbers[1] + "px, " + numbers[0] + "px"
        }[type] : "";
    }
    ...
    function computeArrowTransform(popper, arrow, arrowTransform) {
        var placement = getPopperPlacement(popper), isVertical = "top" === placement || "bottom" === placement, isReverse = "right" === placement || "bottom" === placement, getAxis = function(re) {
            var match = arrowTransform.match(re);
            return match ? match[1] : "";
        }, getNumbers = function(re) {
            var match = arrowTransform.match(re);
            return match ? match[1].split(",").map(parseFloat) : [];
        }, re_translate = /translateX?Y?\(([^)]+)\)/, re_scale = /scaleX?Y?\(([^)]+)\)/, matches = {
            translate: {
                axis: getAxis(/translate([XY])/),
                numbers: getNumbers(re_translate)
            },
            scale: {
                axis: getAxis(/scale([XY])/),
                numbers: getNumbers(re_scale)
            }
        }, computedTransform = arrowTransform.replace(re_translate, "translate" + transformAxis(matches.translate.axis, isVertical) + "(" + transformNumbersBasedOnPlacementAxis("translate", matches.translate.numbers, isVertical, isReverse) + ")").replace(re_scale, "scale" + transformAxis(matches.scale.axis, isVertical) + "(" + transformNumbersBasedOnPlacementAxis("scale", matches.scale.numbers, isVertical, isReverse) + ")");
    ...
    Popper.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Popper.placements = placements, 
    Popper.Defaults = Defaults;
    var matches = {};
    if (isBrowser) {
        var e = Element.prototype;
        matches = e.matches || e.matchesSelector || e.webkitMatchesSelector || e.mozMatchesSelector || e.msMatchesSelector || function(s) {
            for (var matches = (this.document || this.ownerDocument).querySelectorAll(s), i = matches.length; 0 <= --i && matches.item(i) !== this; ) ;
            return -1 < i;
        };
    }
    ...
    function closest(element, parentSelector) {
        return (Element.prototype.closest || function(selector) {
            for (var el = this; el; ) {
                if (matches$1.call(el, selector)) return el;
                el = el.parentElement;
            }
    ...
    function setVisibilityState(els, type) {
        els.forEach(function(el) {
            el && el.setAttribute("data-state", type);
        });
    }
    ...
    function focus(el) {
        var x = window.scrollX || window.pageXOffset, y = window.scrollY || window.pageYOffset;
        el.focus(), scroll(x, y);
    }
    var key = {}, store = function(data) {
        return function(k) {
            return k === key && data;
        };
    }, Tippy = function() {
        function Tippy(config) {
            for (var _key in classCallCheck(this, Tippy), config) this[_key] = config[_key];
            this.state = {
                destroyed: !1,
                visible: !1,
                enabled: !0
        ...
        return createClass(Tippy, [ {
            ...
            value: function(duration) {
                ...
                if (!this.state.destroyed && this.state.enabled) {
                    var popper = this.popper, reference = this.reference, options = this.options, _getInnerElements = getInnerElements(popper), tooltip = _getInnerElements.tooltip, backdrop = _getInnerElements.backdrop, content = _getInnerElements.content;
                    options.dynamicTitle && !reference.getAttribute("data-original-title") || (reference.refObj || document.documentElement.contains(reference) ? (options.onShow.call(popper, this), 
                    duration = getValue(void 0 !== duration ? duration : options.duration, 0), applyTransitionDuration([ popper, tooltip, backdrop ], 0), 
                    popper.style.visibility = "visible", this.state.visible = !0, function(callback) {
                        var options = this.options;
                        this.popperInstance ? (this.popperInstance.scheduleUpdate(), options.livePlacement && !_hasFollowCursorBehavior.call(this) && this.popperInstance.enableEventListeners()) : (this.popperInstance = _createPopperInstance.call(this), 
                        options.livePlacement || this.popperInstance.disableEventListeners());
                        if (!_hasFollowCursorBehavior.call(this)) {
                            var _getInnerElements5 = getInnerElements(this.popper), arrow = _getInnerElements5.arrow;
                            arrow && (arrow.style.margin = ""), this.popperInstance.reference = this.reference;
                        }
                        (function(popperInstance, callback, updateAlreadyCalled) {
                            var popper = popperInstance.popper, options = popperInstance.options, onCreate = options.onCreate, onUpdate = options.onUpdate;
                            options.onCreate = options.onUpdate = function() {
                                (function(popper) {
                                    popper.offsetHeight;
                                })(popper), callback && callback(), onUpdate(), options.onCreate = onCreate, options.onUpdate = onUpdate;
                            }, updateAlreadyCalled || popperInstance.scheduleUpdate();
                        })(this.popperInstance, callback, !0), options.appendTo.contains(this.popper) || options.appendTo.appendChild(this.popper);
                    }.call(this, function() {
                        if (_this.state.visible) {
                            if (_hasFollowCursorBehavior.call(_this) || _this.popperInstance.scheduleUpdate(), 
                            _hasFollowCursorBehavior.call(_this)) {
                                _this.popperInstance.disableEventListeners();
                                var delay = getValue(options.delay, 0), lastTriggerEvent = _this._(key).lastTriggerEvent;
                                lastTriggerEvent && _this._(key).followCursorListener(delay && _this._(key).lastMouseMoveEvent ? _this._(key).lastMouseMoveEvent : lastTriggerEvent);
                            }
                            applyTransitionDuration([ tooltip, backdrop, backdrop ? content : null ], duration), 
                            backdrop && getComputedStyle(backdrop)[prefix("transform")], options.interactive && reference.classList.add("tippy-active"), 
                            options.sticky && function() {
                                var _this9 = this;
                                defer(function updatePosition() {
                                    _this9.popperInstance && _this9.popperInstance.scheduleUpdate(), _this9.popper.style[prefix("transitionDuration")] = _this9.options.updateDuration + "ms", 
                                    _this9.state.visible ? requestAnimationFrame(updatePosition) : _this9.popper.style[prefix("transitionDuration")] = "";
                                });
                            }.call(_this), setVisibilityState([ tooltip, backdrop ], "visible"), _onTransitionEnd.call(_this, duration, function() {
                                options.updateDuration || tooltip.classList.add("tippy-notransition"), options.interactive && focus(popper), 
                                reference.setAttribute("aria-describedby", "tippy-" + _this.id), options.onShown.call(popper, _this);
                            });
                        }
                    })) : this.destroy());
                }
            ...
            value: function(duration) {
                var _this2 = this;
                if (!this.state.destroyed && this.state.enabled) {
                    var popper = this.popper, reference = this.reference, options = this.options, _getInnerElements2 = getInnerElements(popper), tooltip = _getInnerElements2.tooltip, backdrop = _getInnerElements2.backdrop, content = _getInnerElements2.content;
                    options.onHide.call(popper, this), duration = getValue(void 0 !== duration ? duration : options.duration, 1), 
                    options.updateDuration || tooltip.classList.remove("tippy-notransition"), options.interactive && reference.classList.remove("tippy-active"), 
                    popper.style.visibility = "hidden", this.state.visible = !1, applyTransitionDuration([ tooltip, backdrop, backdrop ? content : null ], duration), 
                    setVisibilityState([ tooltip, backdrop ], "hidden"), options.interactive && -1 < options.trigger.indexOf("click") && focus(reference), 
                    defer(function() {
                        _onTransitionEnd.call(_this2, duration, function() {
                            !_this2.state.visible && options.appendTo.contains(popper) && (_this2._(key).isPreparingToShow || (document.removeEventListener("mousemove", _this2._(key).followCursorListener), 
                            _this2._(key).lastMouseMoveEvent = null), reference.removeAttribute("aria-describedby"), 
                            _this2.popperInstance.disableEventListeners(), options.appendTo.removeChild(popper), 
            ...
            key: "destroy",
            value: function() {
                var _this3 = this, destroyTargetInstances = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0];
                if (!this.state.destroyed) {
                    this.state.visible && this.hide(0), this.listeners.forEach(function(listener) {
                        _this3.reference.removeEventListener(listener.event, listener.handler);
                    }), this.title && this.reference.setAttribute("title", this.title), delete this.reference._tippy;
                    [ "data-original-title", "data-tippy", "data-tippy-delegate" ].forEach(function(attr) {
                        _this3.reference.removeAttribute(attr);
                    }), this.options.target && destroyTargetInstances && toArray(this.reference.querySelectorAll(this.options.target)).forEach(function(child) {
                        return child._tippy && child._tippy.destroy();
                    }), this.popperInstance && this.popperInstance.destroy(), this._(key).mutationObservers.forEach(function(observer) {
                        observer.disconnect();
    ...
    function _hasFollowCursorBehavior() {
        ...
        return this.options.followCursor && !browser.usingTouch && lastTriggerEvent && "focus" !== lastTriggerEvent.type;
    }
    function _enter(event) {
        var _this4 = this, options = this.options;
        if (_clearDelayTimeouts.call(this), !this.state.visible) if (options.target) (function(event) {
            var targetEl = closest(event.target, this.options.target);
            if (targetEl && !targetEl._tippy) {
                var title = targetEl.getAttribute("title") || this.title;
                title && (targetEl.setAttribute("title", title), tippy(targetEl, _extends({}, this.options, {
                    target: null
                })), _enter.call(targetEl._tippy, event));
            }
        }).call(this, event); else if (this._(key).isPreparingToShow = !0, options.wait) options.wait.call(this.popper, this.show.bind(this), event); else {
            if (_hasFollowCursorBehavior.call(this)) {
                this._(key).followCursorListener || function() {
                    var _this8 = this;
                    this._(key).followCursorListener = function(event) {
                        ...
                        _this8.popperInstance && (_this8.popperInstance.reference = {
                ...
                var arrow = getInnerElements(this.popper).arrow;
                arrow && (arrow.style.margin = "0"), document.addEventListener("mousemove", this._(key).followCursorListener);
            }
            var delay = getValue(options.delay, 0);
            delay ? this._(key).showTimeout = setTimeout(function() {
                _this4.show();
            }, delay) : this.show();
        }
    }
    function _leave() {
        ...
        if (_clearDelayTimeouts.call(this), this.state.visible) {
            this._(key).isPreparingToShow = !1;
            var delay = getValue(this.options.delay, 1);
            delay ? this._(key).hideTimeout = setTimeout(function() {
                _this5.state.visible && _this5.hide();
            }, delay) : this.hide();
        }
    }
        ...
        return {
            onTrigger: function(event) {
                if (_this6.state.enabled) {
                    var shouldStopEvent = browser.supportsTouch && browser.usingTouch && -1 < [ "mouseenter", "mouseover", "focus" ].indexOf(event.type);
                    shouldStopEvent && _this6.options.touchHold || ("click" === (_this6._(key).lastTriggerEvent = event).type && "persistent" !== _this6.options.hideOnClick && _this6.state.visible ? _leave.call(_this6) : _enter.call(_this6, event), 
                    shouldStopEvent && browser.iOS && _this6.reference.click && _this6.reference.click());
                }
            },
            onMouseLeave: function(event) {
                if (!(-1 < [ "mouseleave", "mouseout" ].indexOf(event.type) && browser.supportsTouch && browser.usingTouch && _this6.options.touchHold)) {
                    if (_this6.options.interactive) {
                        var hide = _leave.bind(_this6);
                        return document.body.addEventListener("mouseleave", hide), void document.addEventListener("mousemove", function onMouseMove(event) {
                            var referenceCursorIsOver = closest(event.target, selectors.REFERENCE), cursorIsOverPopper = closest(event.target, selectors.POPPER) === _this6.popper, cursorIsOverReference = referenceCursorIsOver === _this6.reference;
                            cursorIsOverPopper || cursorIsOverReference || function(event, popper, options) {
                                if (!popper.getAttribute("x-placement")) return !0;
                                var x = event.clientX, y = event.clientY, interactiveBorder = options.interactiveBorder, distance = options.distance, rect = popper.getBoundingClientRect(), placement = getPopperPlacement(popper), borderWithDistance = interactiveBorder + distance, exceeds = {
                            ...
                            }(event, _this6.popper, _this6.options) && (document.body.removeEventListener("mouseleave", hide), 
                            document.removeEventListener("mousemove", onMouseMove), _leave.call(_this6, onMouseMove));
                        });
                    }
                    _leave.call(_this6);
                }
            ...
            onDelegateShow: function(event) {
                closest(event.target, _this6.options.target) && _enter.call(_this6, event);
            },
            onDelegateHide: function(event) {
                closest(event.target, _this6.options.target) && _leave.call(_this6);
            }
        };
    }
    function _createPopperInstance() {
        var _this7 = this, popper = this.popper, reference = this.reference, options = this.options, tooltip = getInnerElements(popper).tooltip, popperOptions = options.popperOptions, arrowSelector = "round" === options.arrowType ? selectors.ROUND_ARROW : selectors.ARROW, arrow = tooltip.querySelector(arrowSelector), config = _extends({
            ...
            onCreate: function() {
                ...
                arrow && options.arrowTransform && computeArrowTransform(popper, arrow, options.arrowTransform);
            },
            onUpdate: function() {
                var styles = tooltip.style;
                styles.top = "", styles.bottom = "", styles.left = "", styles.right = "", styles[getPopperPlacement(popper)] = getOffsetDistanceInPx(options.distance), 
                arrow && options.arrowTransform && computeArrowTransform(popper, arrow, options.arrowTransform);
            }
        });
        ...
        }), new Popper(reference, popper, config);
    }
    ...
    function _addMutationObserver(_ref2) {
        ...
        if (window.MutationObserver) {
            ...
            observer.observe(target, options), this._(key).mutationObservers.push(observer);
        }
    }
    function _onTransitionEnd(duration, callback) {
        if (!duration) return callback();
        var tooltip = getInnerElements(this.popper).tooltip, toggleListeners = function(action, listener) {
            listener && tooltip[action + "EventListener"]("ontransitionend" in window ? "transitionend" : "webkitTransitionEnd", listener);
        }, listener = function listener(e) {
            e.target === tooltip && (toggleListeners("remove", listener), callback());
        };
        toggleListeners("remove", this._(key).transitionendListener), toggleListeners("add", listener), 
        this._(key).transitionendListener = listener;
    }
    var idCounter = 1;
    function createTooltips(els, config) {
        return els.reduce(function(acc, reference) {
            var id = idCounter, options = function(reference, options) {
                return options.arrow && (options.animateFill = !1), options.appendTo && "function" == typeof options.appendTo && (options.appendTo = options.appendTo()), 
                "function" == typeof options.html && (options.html = options.html(reference)), options;
            }(reference, config.performance ? config : function(reference, instanceOptions) {
                var options = defaultsKeys.reduce(function(acc, key) {
                    var val = reference.getAttribute("data-tippy-" + key.toLowerCase()) || instanceOptions[key];
                    return "false" === val && (val = !1), "true" === val && (val = !0), isFinite(val) && !isNaN(parseFloat(val)) && (val = parseFloat(val)), 
                    "target" !== key && "string" == typeof val && "[" === val.trim().charAt(0) && (val = JSON.parse(val)), 
                    acc[key] = val, acc;
                }, {});
                return _extends({}, instanceOptions, options);
            }(reference, config)), title = reference.getAttribute("title");
            if (!(title || options.target || options.html || options.dynamicTitle)) return acc;
            reference.setAttribute(options.target ? "data-tippy-delegate" : "data-tippy", ""), 
            removeTitle(reference);
            var popper = function(id, title, options) {
                var popper = document.createElement("div");
                popper.setAttribute("class", "tippy-popper"), popper.setAttribute("role", "tooltip"), 
                popper.setAttribute("id", "tippy-" + id), popper.style.zIndex = options.zIndex, 
                popper.style.maxWidth = options.maxWidth;
                var tooltip = document.createElement("div");
                if (tooltip.setAttribute("class", "tippy-tooltip"), tooltip.setAttribute("data-size", options.size), 
                tooltip.setAttribute("data-animation", options.animation), tooltip.setAttribute("data-state", "hidden"), 
                options.theme.split(" ").forEach(function(t) {
                    tooltip.classList.add(t + "-theme");
                }), options.arrow) {
                    var arrow = document.createElement("div");
                    arrow.style[prefix("transform")] = options.arrowTransform, "round" === options.arrowType ? (arrow.classList.add("tippy-roundarrow"), 
                    arrow.innerHTML = '<svg viewBox="0 0 24 8" xmlns="http://www.w3.org/2000/svg"><path d="M3 8s2.021-.015 5.253-4.218C9.584 2.051 10.797 1.007 12 1c1.203-.007 2.416 1.035 3.761 2.782C19.012 8.005 21 8 21 8H3z"/></svg>') : arrow.classList.add("tippy-arrow"), 
                    tooltip.appendChild(arrow);
                }
                if (options.animateFill) {
                    tooltip.setAttribute("data-animatefill", "");
                    var circle = document.createElement("div");
                    circle.setAttribute("data-state", "hidden"), circle.classList.add("tippy-backdrop"), 
                    tooltip.appendChild(circle);
                }
                options.inertia && tooltip.setAttribute("data-inertia", ""), options.interactive && tooltip.setAttribute("data-interactive", "");
                var content = document.createElement("div");
                content.setAttribute("class", "tippy-content");
                var html = options.html;
                if (html) {
                    var templateId = void 0;
                    html instanceof Element ? (content.appendChild(html), templateId = "#" + html.id || "tippy-html-template") : (content.innerHTML = document.querySelector(html).innerHTML, 
                    templateId = html), popper.setAttribute("data-html", ""), tooltip.setAttribute("data-template-id", templateId), 
                    options.interactive && popper.setAttribute("tabindex", "-1");
                } else content[options.allowTitleHTML ? "innerHTML" : "textContent"] = title;
                return tooltip.appendChild(content), popper.appendChild(tooltip), popper;
            }(id, title, options), tippy = new Tippy({
                id: id,
                reference: reference,
                popper: popper,
                options: options,
            ...
            options.createPopperInstanceOnInit && (tippy.popperInstance = _createPopperInstance.call(tippy), 
            tippy.popperInstance.disableEventListeners());
            var listeners = _getEventListeners.call(tippy);
            return tippy.listeners = options.trigger.trim().split(" ").reduce(function(acc, eventType) {
                return acc.concat(function(eventType, reference, handlers, options) {
                    var onTrigger = handlers.onTrigger, onMouseLeave = handlers.onMouseLeave, onBlur = handlers.onBlur, onDelegateShow = handlers.onDelegateShow, onDelegateHide = handlers.onDelegateHide, listeners = [];
                    if ("manual" === eventType) return listeners;
                    var on = function(eventType, handler) {
                        reference.addEventListener(eventType, handler), listeners.push({
                            event: eventType,
                            handler: handler
                        });
                    };
                    return options.target ? (browser.supportsTouch && options.touchHold && (on("touchstart", onDelegateShow), 
                    on("touchend", onDelegateHide)), "mouseenter" === eventType && (on("mouseover", onDelegateShow), 
                    on("mouseout", onDelegateHide)), "focus" === eventType && (on("focusin", onDelegateShow), 
                    on("focusout", onDelegateHide)), "click" === eventType && on("click", onDelegateShow)) : (on(eventType, onTrigger), 
                    browser.supportsTouch && options.touchHold && (on("touchstart", onTrigger), on("touchend", onMouseLeave)), 
                    "mouseenter" === eventType && on("mouseleave", onMouseLeave), "focus" === eventType && on(isIE ? "focusout" : "blur", onBlur)), 
                    listeners;
                }(eventType, reference, listeners, options));
            }, []), options.dynamicTitle && _addMutationObserver.call(tippy, {
                target: reference,
                callback: function() {
                    var content = getInnerElements(popper).content, title = reference.getAttribute("title");
                    title && (content[options.allowTitleHTML ? "innerHTML" : "textContent"] = tippy.title = title, 
                    removeTitle(reference));
                },
                options: {
                    attributes: !0
                }
            }), reference._tippy = tippy, popper._tippy = tippy, popper._reference = reference, 
            acc.push(tippy), idCounter++, acc;
        }, []);
    }
    function hideAllPoppers(excludeTippy) {
        toArray(document.querySelectorAll(selectors.POPPER)).forEach(function(popper) {
            ...
            if (tippy) {
                ...
                !(!0 === options.hideOnClick || -1 < options.trigger.indexOf("focus")) || excludeTippy && popper === excludeTippy.popper || tippy.hide();
            }
        });
    }
    var eventListenersBound = !1;
    function tippy(selector, options) {
        var time, onDocumentTouch, onDocumentMouseMove, reference;
        return browser.supported && !eventListenersBound && (onDocumentTouch = function() {
            browser.usingTouch || (browser.usingTouch = !0, browser.iOS && document.body.classList.add("tippy-touch"), 
            browser.dynamicInputDetection && window.performance && document.addEventListener("mousemove", onDocumentMouseMove), 
            browser.onUserInputChange("touch"));
        }, time = void 0, onDocumentMouseMove = function() {
            var now = performance.now();
            now - time < 20 && (browser.usingTouch = !1, document.removeEventListener("mousemove", onDocumentMouseMove), 
            browser.iOS || document.body.classList.remove("tippy-touch"), browser.onUserInputChange("mouse")), 
            time = now;
        }, document.addEventListener("click", function(event) {
            if (!(event.target instanceof Element)) return hideAllPoppers();
            var reference = closest(event.target, selectors.REFERENCE), popper = closest(event.target, selectors.POPPER);
            if (!popper || !popper._reference._tippy.options.interactive) {
                if (reference) {
                    var options = reference._tippy.options;
                    if (!options.multiple && browser.usingTouch || !options.multiple && -1 < options.trigger.indexOf("click")) return hideAllPoppers(reference._tippy);
                    if (!0 !== options.hideOnClick || -1 < options.trigger.indexOf("click")) return;
                }
                hideAllPoppers();
            }
        }), document.addEventListener("touchstart", onDocumentTouch), window.addEventListener("blur", function() {
            var el = document.activeElement;
            el && el.blur && matches$1.call(el, selectors.REFERENCE) && el.blur();
        }), window.addEventListener("resize", function() {
            toArray(document.querySelectorAll(selectors.POPPER)).forEach(function(popper) {
                var tippyInstance = popper._tippy;
                tippyInstance.options.livePlacement || tippyInstance.popperInstance.scheduleUpdate();
            });
        }), browser.supportsTouch || !navigator.maxTouchPoints && !navigator.msMaxTouchPoints || document.addEventListener("pointerdown", onDocumentTouch), 
        eventListenersBound = !0), isObjectLiteral(selector) && ((reference = selector).refObj = !0, 
        reference.attributes = reference.attributes || {}, reference.setAttribute = function(key, val) {
            reference.attributes[key] = val;
        }, reference.getAttribute = function(key) {
            return reference.attributes[key];
        }, reference.removeAttribute = function(key) {
            delete reference.attributes[key];
        }, reference.addEventListener = function() {}, reference.removeEventListener = function() {}, 
        reference.classList = {
            classNames: {},
            add: function(key) {
                return reference.classList.classNames[key] = !0;
            },
            remove: function(key) {
                return delete reference.classList.classNames[key], !0;
            },
            ...
            selector: selector,
            options: options = _extends({}, defaults, options),
            tooltips: browser.supported ? createTooltips(function(selector) {
                if (selector instanceof Element || isObjectLiteral(selector)) return [ selector ];
    ...
    return tippy.version = "2.5.0", tippy.browser = browser, tippy.defaults = defaults, 
    tippy.one = function(selector, options) {
        return tippy(selector, options).tooltips[0];
    }, tippy.disableAnimations = function() {
        defaults.updateDuration = defaults.duration = 0, defaults.animateFill = !1;
    }, function() {
        var css = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "";
        if (isBrowser && browser.supported) {
            var head = document.head || document.querySelector("head"), style = document.createElement("style");
            style.type = "text/css", head.insertBefore(style, head.firstChild), style.styleSheet ? style.styleSheet.cssText = css : style.appendChild(document.createTextNode(css));
        }
    ...
    $(function() {
        $(document).ready(function() {
            window.cb2 = {}, cb2.calendarStyles = function() {
                $(".cb-calendar-grouped").length < 1 || (450 <= $(".cb-calendar-grouped").outerWidth() ? $(".cb-calendar-grouped").addClass("cb-calendar-grouped-large") : $(".cb-calendar-grouped").removeClass("cb-calendar-grouped-large"));
            }, cb2.calendarTooltips = function() {
                $(".cb-calendar-grouped").length < 1 || $('.cb-slot[data-state="allow-booking"] ').parents("li.cb-date").each(function(i, elem) {
            ...
            if (0 < $("#cb_map").length && 0 < $("#cb_map_data").length) {
                var locations = JSON.parse($("#cb_map_data").attr("data-locations")), map = L.map("cb_map");
                L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
                    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
                }).addTo(map);
                var markers = L.featureGroup();
                for (var i in locations) if ("" !== locations[i].geo.lat && "" !== locations[i].geo.lng) {
                    var marker = L.marker([ locations[i].geo.lat, locations[i].geo.lng ]), popupText = "", items = locations[i].items;
                    for (var j in items) popupText += '<p><a href="' + items[j].url + '">' + items[j].title + "</a></p>";
                    marker.bindPopup(popupText), markers.addLayer(marker);
                }
                var bounds = markers.getBounds();
                map.fitBounds(bounds), map.addLayer(markers);
            }
        });
    });
}(jQuery);