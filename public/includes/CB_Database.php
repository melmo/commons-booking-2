...
// --------------------------------------------------------------------
// --------------------------------------------------------------------
class CB2_Database_Query extends CB2_Database {
  ...
  static function factory( $table, $alias = NULL ) {
    return new CB2_Database_Query( $table, $alias );
  }
...
// --------------------------------------------------------------------
// --------------------------------------------------------------------
class CB2_Database_Insert extends CB2_Database {
  ...
  static function factory( $table ) {
    return new CB2_Database_Insert( $table );
  }

  function add_field( $name, $value, $format = NULL ) {
    if ( ! is_null( $value ) )  {
      $this->fields[$name]  = CB2_Database::to_string( $value );
